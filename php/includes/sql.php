...
//création du table "messagerie"
$req = '
        CREATE TABLE IF NOT EXISTS `messagerie`
        (
        `message_id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
        `message_expediteur` int(11),
        `message_destinataire` int(11),
        `message_text` TEXT,
        `message_timestamp` TEXT DEFAULT NULL,
...
$req = '
        ...
        (
        `option_titre` TEXT DEFAULT NULL,
        `option_description` TEXT DEFAULT NULL,
        `option_illustration` TEXT DEFAULT NULL,
        `option_cible` int(11) DEFAULT 75,
        `option_facebook` TEXT DEFAULT NULL,
        `option_twitter` TEXT DEFAULT NULL,
        `option_maintenance` int(11) NOT NULL DEFAULT 0.00,
...
{
$bdd->insert('options',
            array('option_titre','option_description'),
            array('"Le titre de votre site internet"','"La description de votre site internet"')
            );
}

//création du table "categories"
$req = '
...
if($count==0)
{
$bdd->insert('categories',array('categorie_id','categorie_nom','categorie_modifiable'),array('1','"Non classés"','0'));
}


//création du table "sous_categories"
$req = '
        CREATE TABLE IF NOT EXISTS `sous_categories`
        (
        `sous_categorie_id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
        `sous_categorie_nom` VARCHAR(255),
...
//création du table "produits"
$req = '
        CREATE TABLE IF NOT EXISTS `produits`
        (
        `produit_id` INT(11) NOT NULL AUTO_INCREMENT PRIMARY KEY,
        `produit_prix` INT(11),
        `produit_nom` VARCHAR(255),
        `produit_quantite` INT(11),
        `produit_illustration` TEXT,
        `produit_categorie` INT(11),
        `produit_sous_categorie` INT(11),
